...
public class Invoice {
    ...
    private float totalDiscuntPercent;
    private InvoiceLine[] invoiceLines;

    public Invoice(int numInvoice,
                   Date date,
                   String to,
                   String shipTo,
                   String salesPerson,
        ...
        this.shippingTerms = shippmentTerms;
        this.deliveryDate = deliveryDate;
        this.paymentTerms = paymentTerms;
        this.dueDate = dueDate;
        this.totalDiscuntPercent = totalDiscountPercent / 100;
...
printFooter();
    ...
    private void printFooter() {
        ...
        System.out.format("%73s | %8s | %13s |%n",
                "TOTAL DISCOUNT",
                InvoiceLine.customFormat("##.00%", totalDiscuntPercent) ,
                InvoiceLine.customFormat("$#,###,###.00",
                        totalLines * totalDiscuntPercent));
        System.out.format("%102s%n", "----------------------------");
        System.out.format("%84s | %13s |%n",
                "SUBTOTAL",
                InvoiceLine.customFormat("$#,###,###.00",
                        totalLines * (1 - totalDiscuntPercent)));
        System.out.format("%102s%n", "-----------------");
        System.out.format("%84s | %13s |%n",
                "GST",
                InvoiceLine.customFormat("$#,###,###.00",
                        totalLines * (1 - totalDiscuntPercent) * GST));
        System.out.format("%102s%n", "-----------------");
        System.out.format("%84s | %13s |%n",
                "TOTAL",
                InvoiceLine.customFormat("$#,###,###.00",
